...
import com.example.susu.R
import com.example.susu.databinding.FragmentAiMentorBinding
import com.example.susu.databinding.ItemUserQueryBinding
import com.example.susu.databinding.ItemAiResponseBinding
...
class AiMentorFragment : Fragment() {
    ...
    private fun setupChatMenuButton() {
        // Chat menu button is already in the layout, no need to find it separately
    }
